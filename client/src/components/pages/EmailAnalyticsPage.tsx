            ...
            <main className="flex-1 max-w-7xl mx-auto w-full p-6 md:p-10 relative z-10 flex flex-col gap-8">
                <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                    <div>
                        ...
                        <p className="text-[#6B7280] mt-2 font-medium">Track the performance of your email campaigns.</p>
                    </div>
                    ...
                    <div className="w-full md:w-72">
                        <select 
                            ...
                            className="w-full p-4 bg-transparent soft-inset rounded-2xl font-bold focus:outline-none focus:ring-2 focus:ring-[#10B981] appearance-none"
                ...
                {analytics ? (
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {/* Sent & Delivered */}
                        <div className="soft-extruded rounded-[32px] p-8 flex flex-col gap-2">
                            <div className="flex items-center gap-2 text-[#6B7280] mb-2 font-bold uppercase tracking-wider text-xs">
                                <Mail size={16} className="text-[#3B82F6]" /> Sent & Delivered
                            </div>
                            <div className="text-5xl font-extrabold text-[#3D4852]">{analytics.total_sent}</div>
                        ...
                        <div className="soft-extruded rounded-[32px] p-8 flex flex-col gap-2">
                            ...
                            <div className="text-sm font-bold text-[#6B7280] mt-2">
                    ...
                    <div className="soft-inset rounded-[32px] p-20 flex items-center justify-center text-[#6B7280] font-bold text-lg">
